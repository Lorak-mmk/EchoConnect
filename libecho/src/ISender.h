...
public:
     ...
     *
     * Derived classes should call it.
     * Also, responsibility for initialization of output and outputFormat members
     * is on derived classes.
     *
     * @param windowSize  How much of bitrate we want to use to play sound in which unit od data is encoded.
     */
    ISender(int windowSize) : windowSize(windowSize) {}
