...
/**
 * @brief Class which performs data to/from audio conversions by encoding every bit separately.
 *
 ...
 * value. We consider it to be the simpliest possible way to encode data into a sound and because of that we decided to
...
public:
    ...
    /**
     * @brief Temporary unused implementation - done only to ensure that code compiles.
     *
...
private:
     ...
     * @brief Temporary unused implementation - done only to ensure that code compiles.
     *
     * TODO for @PawelA: implementation and documentation
     */
